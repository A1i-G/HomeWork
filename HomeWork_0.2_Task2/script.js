...
// const task9 = number1.filter(number => number % 3 === 2);
...
// function users11(){
//     result = arr2.reduce((maxIndex, obj, currentIndex) => {
...
// function users12() {
//     const result = arr2.filter(obj => obj.name.search('l'),);
...
function users13() {
  const result = arr2.filter((obj) => obj.name.search("t"));
